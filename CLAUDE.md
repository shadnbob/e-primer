...
This is the E-Prime Bias Detector, a browser extension that detects biased language patterns in web content using E-Prime principles and advanced linguistic analysis. The extension identifies 18 different types of linguistic patterns — 15 bias types plus three "explainer" types that annotate contested terms (political spectrum labels, science & statistics phrases, political -isms) with context — and includes an excellence detection system that highlights good writing practices.
...
- `src/dictionaries/`: Pattern definitions for each bias type (18 dictionary files + index)
...
The extension detects patterns in 5 main categories (18 types total, all enabled by default):
