...
Eight types currently have subcategories (opinion, euphemism, emotional, weasel, maximizer, gaslighting, spectrum, scistats). To add subcategories to another type or extend existing ones:
